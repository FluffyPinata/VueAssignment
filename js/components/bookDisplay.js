app.component('book-display', {
	...
	template:
        ...
        <li class = "list-group-item" v-if="typeof this.bookObj.volumeInfo.imageLinks.smallThumbnail !== undefined">
        	<img src="this.bookObj.volumeInfo.imageLinks.smallThumbnail">
        </li>
        </ul>`,
